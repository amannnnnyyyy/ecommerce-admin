...
export const CellAction:React.FC<CellActionProps> =({data}) =>{
    ...
    const onDelete = async ()=>{
        try {
            ...
            toast.error("Make sure you removed all products inside the category first!")
        }finally{
            setLoading(false)
            setOpen(false)
        }
       ...
       <>
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem onClick={()=>router.push(`/${params.storeId}/categories/${data.id}`)}><Edit className="mr-2 h-4 w-4 text-blue-600"/>Update</DropdownMenuItem>
